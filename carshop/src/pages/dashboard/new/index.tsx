  ...
  return (
    <Container>
      ...
      <div className="w-full bg-white p-3 rounded-lg flex flex-col sm:flex-row items-center gap-2">
        <button className="border-2 w-48 rounded-lg flex items-center justify-center cursor-pointer border-blue-600 h-32 md:w-48">
          <div className="absolute cursor-pointer">
            <FiUpload size={30} color="#1890ff" />
          </div>
      ...
      <div className="w-full bg-white p-3 rounded-lg flex flex-col sm:flex-row items-center gap-2 mt-2">
        ...
        >
          ...
          <button type="submit" className="w-full rounded-md bg-blue-600 text-white font-medium h-10">
            Cadastrar
          </button>
