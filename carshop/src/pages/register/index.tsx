  ...
  return (
    <Container>
      ...
      <Link to="/" className="mb-6 max-w-sm">
        <h1 className=" rounded-md bg-blue-600 px-10 py-2 text-2xl font-semibold text-white text-center sm:text-2xl">
              CarShop
            </h1>
        </Link>
        ...
        >
          ...
          <Button type="primary" htmlType="submit" className="w-full rounded-md text-white h-10 font-medium">
              Cadastrar
            </Button>
